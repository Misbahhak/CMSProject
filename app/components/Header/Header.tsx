        ...
        <header className="bg-white border-gray-200 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="hotelz Logo" />
                    <span className="self-center text-2xl whitespace-nowrap dark:text-white font-black text-tertiary-dark">Hotelzz</span>
                </Link>
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <Link href="/" className="hover:-translate-y-2 duration-500 transition-all  block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Home</Link>
                        </li>
                        <li>
                            <Link href="/about" className="hover:-translate-y-2 duration-500 transition-all  block py-2 px-3 text-gray-900 rounded md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About</Link>
                        </li>
                        <li>
                            <Link href="/services" className="hover:-translate-y-2 duration-500 transition-all  block py-2 px-3 text-gray-900 rounded md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</Link>
                        </li>
                        <li>
            ...
            {/* <header classNameName='py-10 px-4 container mx-auto text-xl flex flex-wrap md:flex-nowrap items-center justify-between'>
            <div classNameName='flex items-center w-full md:2/3'>
                <Link href='/' classNameName='font-black text-tertiary-dark'>
                    Hotelzz
                </Link>
                <ul classNameName=" flex items-center ml-5">
                    <li classNameName="flex items-center">
                        <Link href='/auth'>
                            <FaUserCircle classNameName="cursor-pointer" />
                        </Link>
                    </li>
                    <li classNameName="ml-2">
                        <MdDarkMode classNameName="cursor-pointer" />
                    </li>

                </ul>


                <ul classNameName='flex items-center justify-between w-full md:w-1/3 mt-4'>
                    <li classNameName='hover:-translate-y-2 duration-500 transition-all'>
                        <Link href='/'>Home</Link>
                    </li>
                    <li classNameName='hover:-translate-y-2 duration-500 transition-all'>
